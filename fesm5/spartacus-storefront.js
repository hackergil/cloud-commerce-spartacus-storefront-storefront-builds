...
import { I18nModule, CartService, UrlTranslationModule, ConfigModule, CartModule, CheckoutService, GlobalMessageService, GlobalMessageType, UserService, RoutingService, CartDataService, CheckoutModule, ServerConfig, WindowRef, Config, CmsConfig, provideConfigFactory, serverConfigFromMetaTagFactory, TranslationService, TranslationNamespaceService, AuthService, RoutingModule, ProductService, AuthGuard, UserModule, CmsService, GoogleMapRendererService, StoreDataService, StoreFinderService, provideConfig, StateModule, AuthModule, CxApiModule, SmartEditModule, defaultCmsModuleConfig, CmsModule, LANGUAGE_CONTEXT_ID, CURRENCY_CONTEXT_ID, ContextServiceMap, ProductReviewService, SiteContextModule, StripHtmlModule, PageMetaService, CmsPageTitleModule, ProductModule, ProductSearchService, PageType, OccUserService, OccMiscsService, OccOrderService, OccConfig, GlobalMessageModule, StoreFinderCoreModule, DynamicAttributeService, NotAuthGuard, CxApiService, ComponentMapperService, PageRobotsMeta } from '@spartacus/core';
