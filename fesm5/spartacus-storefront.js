...
import { Injectable, NgModule, APP_INITIALIZER, ChangeDetectionStrategy, Component, Input, ElementRef, ViewChild, Output, EventEmitter, Renderer2, Injector, ChangeDetectorRef, HostBinding, Directive, TemplateRef, ViewEncapsulation, forwardRef, HostListener, Optional, defineInjectable, inject, Inject, PLATFORM_ID, INJECTOR, ViewContainerRef } from '@angular/core';
